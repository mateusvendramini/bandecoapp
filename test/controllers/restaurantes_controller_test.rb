...
class RestaurantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create restaurante" do
    assert_difference('Restaurante.count') do
      post restaurantes_url, params: { restaurante: { cardapio: @restaurante.cardapio, foto: @restaurante.foto, layout: @restaurante.layout, mapa: @restaurante.mapa, nome: @restaurante.nome } }
    end
  ...
  test "should update restaurante" do
    patch restaurante_url(@restaurante), params: { restaurante: { cardapio: @restaurante.cardapio, foto: @restaurante.foto, layout: @restaurante.layout, mapa: @restaurante.mapa, nome: @restaurante.nome } }
